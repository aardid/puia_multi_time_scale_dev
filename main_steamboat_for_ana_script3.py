...
data_streams=['zsc2_rsamF','zsc2_dsarF','zsc2_mfF','zsc2_hfF']#['zsc2_rsamF','zsc2_dsarF','zsc2_mfF','zsc2_hfF']#['zsc2_rsam','zsc2_dsar','zsc2_mf','zsc2_hf']
Ncl=300
n_jobs=5
...
def ROC_cross_validation(dir_path):
    '''
    '''
    only_for_station = None#'CAU'#None#'BELO' # None
